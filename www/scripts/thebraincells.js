...
window.onload = function () {
  var thebraincells = new TheBrainCells();
  thebraincells.init();
};
var TheBrainCells = function () {
  this.socket = null;
};
TheBrainCells.prototype = {
  init: function () {
    var that = this;
    this.socket = io.connect();
    this.socket.on("connect", function () {
      document.getElementById("info").textContent =
        "Get Yourself A Nickname Of Your Choice";
    ...
    this.socket.on("loginSuccess", function () {
      document.title =
        "TheBrainCells | " + document.getElementById("nicknameInput").value;
